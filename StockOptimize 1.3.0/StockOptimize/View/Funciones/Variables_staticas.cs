...
namespace StockOptimize.View.Funciones
{
    public class Variables_staticas
    {
        ...
        public static List<BaseDatos> listaTablas { get; set; } = new List<BaseDatos>();

        public static List<string> listaDatos { get; set; } = new List<string>();

        public static string BaseDatos { get; set; } = null;
    }
